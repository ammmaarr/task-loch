  ...
  return (
    <div className="flex flex-col gap-10 bg-white">
      ...
      <div className="flex flex-col gap-6">
        ...
        <button
          onClick={onSubmit}
          className="bg-main-dark hover:bg-white hover:text-main-dark hover:border-main-dark border border-transparent transition-all duration-500 py-[18px] px-7 text-white rounded-lg text-base font-semibold"
        >
          Get started
        </button>
      </div>
      <label className="text-base font-semibold text-main-dark">
